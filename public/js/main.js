...
const more = builder.create("div").className("more").appendTo(mainContainer);
builder
  .create("a")
  .html('See All Photos <i class="fas fa-angle-double-right"></i>')
  .url("/gallery")
  .appendTo(more);
